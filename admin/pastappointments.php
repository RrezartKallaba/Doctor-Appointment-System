        ...
        <div class="dashboard">
                ...
                <nav>
                    <section class="manage">
                        ...
                        <ul>
                            ...
                            <li class="active">
                                <a href="pastappointments.php" style="color: #4b84fe;">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 576 512">
            ...
            <main class="content-wrap">
                ...
                <div class="content">
                    ...
                    $sqlTodayAppointments = "SELECT COUNT(appointment_id) AS past_appointment_count FROM appointments WHERE appointment_date < '$currentDate'";
                    ...
                    <section class="info-boxes">
                        ...
                        <a style="text-decoration: none;" href="#today-controls">
                            <div class="info-box active">
                                ...
                                <div class="box-content">
                                    <span class="big"><?php echo $rowTodayAppointments["past_appointment_count"]; ?></span>
                                    Past Appointments
                                </div>
                            </div>
                        </a>
                        ...
                        <div class="table-doctors">
                            ...
                            <table cellspacing="0" class="table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    $sqlTodayControls = "SELECT * FROM appointments WHERE appointment_date < '$currentTodayDate' ORDER BY appointment_date DESC";
