      ...
      <header id="myLinks" class="menu-wrap">
        ...
        <nav>
          <section class="manage">
            ...
            <ul>
              <li class="active">
                <a href="dashboard.php" style="color: #4b84fe;">
      ...
      <main class="content-wrap">
        ...
        if (isset($_SESSION['profile_deleted'])) {
          echo "<div id='success-alert' class='alert alert-success'>
                        <p style='text-align:center;'>" . $_SESSION['profile_deleted'] . "</p>
                      </div>";
        ...
        <?php
        if (isset($_SESSION['added-doctor'])) {
          echo "<div id='success-alert' class='alert alert-success'>
                          <p style='text-align:center;'>" . $_SESSION['added-doctor'] . "</p>
                      </div>";
          unset($_SESSION['added-doctor']);
        }
        ?>
        <script>
          setTimeout(function() {
        ...
        <div class="content">
          ...
          <section class="info-boxes">
            ...
            <a style="text-decoration: none;" href="upcomingappointments.php">
              <div class="info-box">
                <div class="box-icon">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 576 512">
                    <path d="M142.4 21.9c5.6 16.8-3.5 34.9-20.2 40.5L96 71.1V192c0 53 43 96 96 96s96-43 96-96V71.1l-26.1-8.7c-16.8-5.6-25.8-23.7-20.2-40.5s23.7-25.8 40.5-20.2l26.1 8.7C334.4 19.1 352 43.5 352 71.1V192c0 77.2-54.6 141.6-127.3 156.7C231 404.6 278.4 448 336 448c61.9 0 112-50.1 112-112V265.3c-28.3-12.3-48-40.5-48-73.3c0-44.2 35.8-80 80-80s80 35.8 80 80c0 32.8-19.7 61-48 73.3V336c0 97.2-78.8 176-176 176c-92.9 0-168.9-71.9-175.5-163.1C87.2 334.2 32 269.6 32 192V71.1c0-27.5 17.6-52 43.8-60.7l26.1-8.7c16.8-5.6 34.9 3.5 40.5 20.2zM480 224a32 32 0 1 0 0-64 32 32 0 1 0 0 64z" />
              ...
              <table cellspacing="0" class="table table-bordered">
                <thead>
                  <tr>
                    ...
                    <th class="column-doctorSpc">Specialization</th>
                ...
                <tbody>
                  <?php
                  require_once "../validate/connect.php";
                  $sqlDocInfo = "SELECT * FROM doctors";
                  $resultDocInfo = mysqli_query($connect, $sqlDocInfo);

                  if (mysqli_num_rows($resultDocInfo) > 0) {
                    while ($rowDocInfo = mysqli_fetch_assoc($resultDocInfo)) {
                      echo '<tr>
                        <td class="column-tdId">' . $rowDocInfo["doctor_id"] . '</td>
                        <td class="column-tdName">' . $rowDocInfo["name"] . '</td>
                        <td class="column-tdSpc">' . $rowDocInfo["specialization"] . '</td>
                        <td class="column-tdBtn">';
                      echo '<a href="crud/doctor_details.php?id=' . $rowDocInfo["doctor_id"] . '" class="action-icons"><svg class="details-icon" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 512 512"><path d="M256 512A256 256 0 1 0 256 0a256 256 0 1 0 0 512zM216 336h24V272H216c-13.3 0-24-10.7-24-24s10.7-24 24-24h48c13.3 0 24 10.7 24 24v88h8c13.3 0 24 10.7 24 24s-10.7 24-24 24H216c-13.3 0-24-10.7-24-24s10.7-24 24-24zm40-208a32 32 0 1 1 0 64 32 32 0 1 1 0-64z"/></svg></a> ';
                      echo '<a href="crud/update_doctors.php?id=' . $rowDocInfo["doctor_id"] . '" class="action-icons"><svg class="update-icon" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 512 512"><path d="M362.7 19.3L314.3 67.7 444.3 197.7l48.4-48.4c25-25 25-65.5 0-90.5L453.3 19.3c-25-25-65.5-25-90.5 0zm-71 71L58.6 323.5c-10.4 10.4-18 23.3-22.2 37.4L1 481.2C-1.5 489.7 .8 498.8 7 505s15.3 8.5 23.7 6.1l120.3-35.4c14.1-4.2 27-11.8 37.4-22.2L421.7 220.3 291.7 90.3z"/></svg></a> ';
                      echo '<a href="admin_validate/validateDeleteDoctor.php?id=' . $rowDocInfo["doctor_id"] . '" class="action-icons" onclick="return confirm(\'Are you sure you want to delete this doctor?\')"><svg class="delete-icon" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 448 512"><path d="M170.5 51.6L151.5 80h145l-19-28.4c-1.5-2.2-4-3.6-6.7-3.6H177.1c-2.7 0-5.2 1.3-6.7 3.6zm147-26.6L354.2 80H368h48 8c13.3 0 24 10.7 24 24s-10.7 24-24 24h-8V432c0 44.2-35.8 80-80 80H112c-44.2 0-80-35.8-80-80V128H24c-13.3 0-24-10.7-24-24S10.7 80 24 80h8H80 93.8l36.7-55.1C140.9 9.4 158.4 0 177.1 0h93.7c18.7 0 36.2 9.4 46.6 24.9zM80 128V432c0 17.7 14.3 32 32 32H336c17.7 0 32-14.3 32-32V128H80zm80 64V400c0 8.8-7.2 16-16 16s-16-7.2-16-16V192c0-8.8 7.2-16 16-16s16 7.2 16 16zm80 0V400c0 8.8-7.2 16-16 16s-16-7.2-16-16V192c0-8.8 7.2-16 16-16s16 7.2 16 16zm80 0V400c0 8.8-7.2 16-16 16s-16-7.2-16-16V192c0-8.8 7.2-16 16-16s16 7.2 16 16z"/></svg></a>';
                      echo '</td>
                        </tr>';
                    }
                  } else {
                    echo '<tr style="text-align: center;"><td colspan="4" class="text-center">No result found</td></tr>';
                  }
                  ?>
