        ...
        <div class="dashboard">
            ...
            <main class="content-wrap">
                <div class="content">
                    ...
                    $id = $_GET["id"];
                    $sql = "SELECT * FROM doctors WHERE doctor_id = $id"; // alias
                    $result = mysqli_query($connect, $sql);
                    $row = mysqli_fetch_assoc($result);

                    $currentDate = date("Y-m-d"); // Marrja e dates aktuale
                    $sqlAppointments = "SELECT COUNT(appointment_id) AS appointment_count FROM appointments WHERE doctor_id = $id AND appointment_date > '$currentDate'";
                    $resultAppointments = mysqli_query($connect, $sqlAppointments);
                    $rowAppointments = mysqli_fetch_assoc($resultAppointments);

                    $sqlTodayAppointments = "SELECT COUNT(appointment_id) AS today_appointment_count FROM appointments WHERE doctor_id = $id AND appointment_date = '$currentDate'";
                        ...
                        <a style="text-decoration: none;" href="../dashboard.php">
                            <div class="info-box active">
                                ...
                                <div class="box-content">
                                    <span class="big" style="font-size: 20px;"><?php echo $row["name"]; ?></span>
                                    Current Doctor
                                </div>
                            </div>
                        </a>
                            ...
                            <table cellspacing="0" class="table table-bordered">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="column-appoId">Appointment ID</th>
                                ...
                                <tbody>
                                    ...
                                    $sqlTodayControls = "SELECT * FROM doctors doc, appointments appo WHERE doc.doctor_id = appo.doctor_id AND appo.doctor_id = $id AND appo.appointment_date = '$currentTodayDate' ORDER BY appo.appointment_date";
                        ...
                        <div class="table-doctors">
                            ...
                            <table cellspacing="0" class="table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    $sqlUpcomingControls = "SELECT * FROM doctors doc, appointments appo WHERE doc.doctor_id = appo.doctor_id AND appo.doctor_id = $id AND appo.appointment_date > '$currentUpcomingDate' ORDER BY appo.appointment_date";
