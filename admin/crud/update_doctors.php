    ...
    <body>
        <div class="dashboard">
            ...
            <main class="content-wrap">
                <div class="content">
                    <div class="container">
                        <?php require_once "../admin_validate/validateUpdate.php" ?>
                        <div class="card">
                            <div class="card-header">
                                <?php
                                if (isset($_SESSION['profile_updated'])) {
                                    echo "<div id='success-alert' class='alert alert-success'>
                                        <p style='text-align:center;'>" . $_SESSION['profile_updated'] . "</p>
                                     </div>";
                                ...
                                <h4 style="font-size: 23px;color: black;">Update Doctor Info</h4>
                            </div>
                            <div class="card-body">
                                <form method="post">
